...
const confirmSubmit = async () => {
    ...
    try {
        await Api.post('/direktur/galleries/bulk-store', formData)
            ...
            <main class="p-6">
                <div class="max-w-4xl mx-auto">
                    <div class="mb-6 flex justify-between items-end">
                        <div>
                            <button @click="router.push('/direktur/gallery')" class="text-slate-400 hover:text-slate-600 text-sm font-bold flex items-center gap-2 mb-2">
