...
const breadcrumbsData = ref([
    { label: 'Gallery', link: '/direktur/gallery' }
])
...
const fetchGalleries = async () => {
    ...
    try {
        const response = await Api.get('/direktur/galleries')
...
const confirmDelete = async () => {
    ...
    try {
        await Api.post('/direktur/galleries/bulk-delete', { ids: deleteModal.value.album.ids })
        ...
        <div class="flex-1 relative max-w-full overflow-hidden">
            ...
            <main class="p-4 sm:p-6 w-full">
                <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 mb-6">
                    ...
                    <router-link to="/direktur/gallery/tambah" class="bg-blue-600 hover:bg-blue-700 text-white px-5 py-2.5 rounded-xl font-bold transition-all flex items-center justify-center gap-2 shadow-sm shadow-blue-600/30 w-full sm:w-auto">
