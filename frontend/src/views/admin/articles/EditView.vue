          ...
          <form v-else @submit.prevent="confirmUpdate" enctype="multipart/form-data">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              ...
              <div>
                ...
                <input id="meta_keywords" name="meta_keywords" v-model="form.meta_keywords" type="text" class="w-full border border-slate-300 p-3 rounded-xl focus:ring-2 focus:ring-slate-900 outline-none font-bold text-black" placeholder="pisahkan, dengan, koma">
              </div>
