...
<template>
  ...
  <a v-if="!hideLayoutNav" 
     href="https://wa.me/6285284201428?text=Halo%20PT%20Cakrawala%20Parama%20Internasional%2C%20saya%20tertarik%20dengan%20layanan%20Anda%20dan%20ingin%20berkonsultasi."
     target="_blank"
     :class="[
       'fixed right-8 z-50 flex items-center justify-center w-14 h-14 bg-emerald-500 rounded-full shadow-2xl hover:bg-emerald-600 transition-all duration-500 ease-out hover:-translate-y-1 hover:scale-110 active:scale-95 group',
       isScrolled ? 'bottom-28' : 'bottom-10'
     ]"
