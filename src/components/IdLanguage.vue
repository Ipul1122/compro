...
const dummyProjects = [
    {
        // id: 'LMS-2026',
        title: 'Pendampingan Dalam Pengembangan Soal Tes SKB Untuk Jabatan Fungsional Bidang Legislatif',
        category: 'Organizational Development',
        // description: 'Guidance in developing SKB test questions for the Functional Position of Legislative Affairs.',
        // tags: ['VUE_JS', 'NODE_JS', 'BIG_DATA'],
    },
    {
        // id: 'EVT-2025',
        title: 'Penyusunan Rencana Pengembangan Sumber Daya Manusia (HCDP)',
        category: 'Organizational Development',
        // description: 'Preparation of the Human Capital Development Plan (HCDP).',
        // tags: ['AUTOMATION', 'QR_SCAN', 'ANALYTICS'],
    },
    {
        // id: 'INT-2025',
        title: 'Pengembangan Sistem Informasi Jabatan Fungsional untuk Dewan Perwakilan Rakyat Republik Indonesia (DPR RI)',
        category: 'Organizational Development',
        // description: 'evelopment of the Functional Position Information System for the Indonesian House of Representatives (DPR RI) .',
        // tags: ['STRATEGY', 'BRANDING', 'INTERIOR'],
    },
    {
        // id: 'INT-2025',
        title: 'Pembuatan e-book Untuk Sosialisasi Program Stunting BKKBN',
        category: 'Organizational Development',
        // description: 'evelopment of the Functional Position Information System for the Indonesian House of Representatives (DPR RI) .',
        // tags: ['STRATEGY', 'BRANDING', 'INTERIOR'],
    },
    {
        // id: 'INT-2025',
        title: 'Pengembangan Sistem Manajemen Sumber Daya Manusia (HRIS) di STMT, STP, STBM, STIA, dan STIK Trisakti.',
        category: 'Organizational Development',
        // description: 'evelopment of the Functional Position Information System for the Indonesian House of Representatives (DPR RI) .',
        // tags: ['STRATEGY', 'BRANDING', 'INTERIOR'],
    },
    {
        // id: 'INT-2025',
        title: 'Produksi Video Pelatihan Untuk BKKBN',
        category: 'Organizational Development',
        // description: 'evelopment of the Functional Position Information System for the Indonesian House of Representatives (DPR RI) .',
        // tags: ['STRATEGY', 'BRANDING', 'INTERIOR'],
    },
    {
        // id: 'INT-2025',
        title: 'Pengembangan Analisis Beban Kerja dan Indikator Kinerja Utama (KPI) untuk Perguruan Tinggi Trisakti',
        category: 'Organizational Development',
        // description: 'evelopment of the Functional Position Information System for the Indonesian House of Representatives (DPR RI) .',
        // tags: ['STRATEGY', 'BRANDING', 'INTERIOR'],
    },
    {
        // id: 'CONS-2024',
        title: 'Pelaksanaan Tes Seleksi Kompetensi Dasar di Kementerian Perhubungan Republik Indonesia, tahun 2021',
        category: 'Event Organizer',
        // description: 'Administration of the Basic Competency Selection Test at the Ministry of Transportation of the Republic of Indonesia, 2021 .',
        // tags: ['CONSULTING', 'HR_STRATEGY', 'KPI'],
    },
    {
        // id: 'CONS-2024',
        title: 'Pelaksanaan Kegiatan Hari Museum Nasional Tahun 2023',
        category: 'Event Organizer',
        // description: 'Administration of the Basic Competency Selection Test at the Ministry of Transportation of the Republic of Indonesia, 2021 .',
        // tags: ['CONSULTING', 'HR_STRATEGY', 'KPI'],
    },
    {
        // id: 'CONS-2024',
        title: 'Rapat Koordinasi Badan Keahlian untuk Evaluasi Kinerja guna Meningkatkan Sinergi serta Memperkuat Produk dan Layanan Badan Keahlian (BKD), Tahun 2024',
        category: 'Event Organizer',
        // description: 'Administration of the Basic Competency Selection Test at the Ministry of Transportation of the Republic of Indonesia, 2021 .',
        // tags: ['CONSULTING', 'HR_STRATEGY', 'KPI'],
    },
    {
        // id: 'CONS-2024',
        title: 'Siaran Pers untuk Badan Reserse Kriminal (Bareskrim), Markas Besar Kepolisian Negara Republik Indonesia, Tahun 2025',
        category: 'Event Organizer',
        // description: 'Administration of the Basic Competency Selection Test at the Ministry of Transportation of the Republic of Indonesia, 2021 .',
        // tags: ['CONSULTING', 'HR_STRATEGY', 'KPI'],
    },
    {
        // id: 'CONS-2024',
        title: '“Dari Conefo ke Rumah Rakyat” – Hubungan Masyarakat Dewan Perwakilan Rakyat Republik Indonesia (DPR RI), Tahun 2025',
        category: 'Event Organizer',
        // description: 'Administration of the Basic Competency Selection Test at the Ministry of Transportation of the Republic of Indonesia, 2021 .',
        // tags: ['CONSULTING', 'HR_STRATEGY', 'KPI'],
    },
    {
        // id: 'CONS-2024',
        title: 'Penilaian Seluruh Pegawai Dewan Perwakilan Daerah Republik Indonesia (DPD RI)',
    ...
    {
        // id: 'CONS-2024',
        title: 'Penilaian Pegawai di Kementerian Pekerjaan Umum Republik Indonesia (PU RI)',
        category: 'Employee Potential',
        // description: 'Administration of the Basic Competency Selection Test at the Ministry of Transportation of the Republic of Indonesia, 2021 .',
        // tags: ['CONSULTING', 'HR_STRATEGY', 'KPI'],
    },
    {
        // id: 'CONS-2024',
        title: 'Penilaian Untuk Seleksi Jabatan Pimpinan Eselon I di Dewan Perwakilan Rakyat Republik Indonesia (DPR RI)',
        category: 'Employee Potential',
        // description: 'Administration of the Basic Competency Selection Test at the Ministry of Transportation of the Republic of Indonesia, 2021 .',
        // tags: ['CONSULTING', 'HR_STRATEGY', 'KPI'],
    },
    {
        // id: 'CONS-2024',
        title: 'Asesmen Potensi Calon Pegawai Negeri Sipil (CPNS) di Dewan Perwakilan Rakyat Republik Indonesia (DPR RI)',
        category: 'Employee Potential',
        // description: 'Administration of the Basic Competency Selection Test at the Ministry of Transportation of the Republic of Indonesia, 2021 .',
        // tags: ['CONSULTING', 'HR_STRATEGY', 'KPI'],
    },
    {
        // id: 'CONS-2024',
        title: 'Rekrutmen Peserta Seminar Parlemen Pemuda Tahun 2023',
        category: 'Employee Potential',
        // description: 'Administration of the Basic Competency Selection Test at the Ministry of Transportation of the Republic of Indonesia, 2021 .',
        // tags: ['CONSULTING', 'HR_STRATEGY', 'KPI'],
    },
    {
        // id: 'CONS-2024',
        title: 'Tes Psikometrik Bagi Calon Tenaga Ahli Anggota DPR RI Untuk Masa Jabatan 2024–2029 (Tahun 2025)',
        category: 'Employee Potential',
        // description: 'Administration of the Basic Competency Selection Test at the Ministry of Transportation of the Republic of Indonesia, 2021 .',
        // tags: ['CONSULTING', 'HR_STRATEGY', 'KPI'],
    },
    {
        // id: 'CONS-2024',
        title: 'Workshop Transformasi Diri Untuk Meningkatkan Motivasi Kerja & Manajemen Stres, Tahun 2023.',
    ...
    {
        // id: 'CONS-2024',
        title: 'Seminar Nasional Penguatan Implementasi Sistem Pendidikan Nasional melalui Evaluasi dan Penyempurnaan Regulasi di Bidang Pendidikan, Puspanlak DPR RI, Tahun 2024',
        category: 'Workshop and Training',
        // description: 'Administration of the Basic Competency Selection Test at the Ministry of Transportation of the Republic of Indonesia, 2021 .',
        // tags: ['CONSULTING', 'HR_STRATEGY', 'KPI'],
    },
    {
        // id: 'CONS-2024',
        title: 'Workshop Peningkatan Kompetensi dan Kapasitas Kinerja Pegawai, Dengan tema: “Pengambilan Keputusan dan Kepemimpinan Adaptif”',
        category: 'Workshop and Training',
        // description: 'Administration of the Basic Competency Selection Test at the Ministry of Transportation of the Republic of Indonesia, 2021 .',
        // tags: ['CONSULTING', 'HR_STRATEGY', 'KPI'],
    },
    {
        // id: 'CONS-2024',
        title: 'Kegiatan Teambuilding dan Pelatihan Outbound untuk Memperkuat Kolaborasi Tim',
        category: 'Workshop and Training',
        // description: 'Administration of the Basic Competency Selection Test at the Ministry of Transportation of the Republic of Indonesia, 2021 .',
        // tags: ['CONSULTING', 'HR_STRATEGY', 'KPI'],
    },
    {
        // id: 'CONS-2024',
        title: 'Workshop “Resilience & Global Mindset”, SBM ITB, Tahun 2025',
        category: 'Workshop and Training',
        // description: 'Administration of the Basic Competency Selection Test at the Ministry of Transportation of the Republic of Indonesia, 2021 .',
        // tags: ['CONSULTING', 'HR_STRATEGY', 'KPI'],
    },
    {
        // id: 'CONS-2024',
        title: 'Coaching Individu (one-on-one) Bagi Pegawai Untuk Membantu Merencanakan Jalur Karier Serta Menyelaraskan Tujuan Individu Dengan Tujuan Organisasi di Instansi Pemerintah',
    ...
    {
        // id: 'CONS-2024',
        title: 'Pendampingan Bagi Calon Lulusan ITB Dalam Merencanakan Karier Mereka',
        category: 'Coaching and Counseling',
        // description: 'Administration of the Basic Competency Selection Test at the Ministry of Transportation of the Republic of Indonesia, 2021 .',
        // tags: ['CONSULTING', 'HR_STRATEGY', 'KPI'],
    },
    {
        // id: 'CONS-2024',
        title: 'Mendukung Para Wirausaha Selama Masa COVID Untuk Membangun Ketahanan yang Lebih Kuat Serta Mempertahankan Keberlangsungan Usaha di Tengah Kondisi Pandemi',
        category: 'Coaching and Counseling',
        // description: 'Administration of the Basic Competency Selection Test at the Ministry of Transportation of the Republic of Indonesia, 2021 .',
        // tags: ['CONSULTING', 'HR_STRATEGY', 'KPI'],
    },
    ...
    {
        // id: 'CONS-2024',
        title: 'Pelatihan dan Sertifikasi Manajemen Komunikasi Organisasi bagi Pegawai dengan Sertifikasi BNSP',
        category: 'Coaching and Counseling',
        // description: 'Administration of the Basic Competency Selection Test at the Ministry of Transportation of the Republic of Indonesia, 2021 .',
        // tags: ['CONSULTING', 'HR_STRATEGY', 'KPI'],
    },
    {
        // id: 'CONS-2024',
        title: 'ISO 9001:2015 – Sistem Manajemen Mutu untuk Unit Pelayanan Kesehatan DPR RI, Tahun 2025',
        category: 'Coaching and Counseling',
        // description: 'Administration of the Basic Competency Selection Test at the Ministry of Transportation of the Republic of Indonesia, 2021 .',
        // tags: ['CONSULTING', 'HR_STRATEGY', 'KPI'],
    }
...
const itemsToShow = 5 // Jumlah awal proyek yang tampil
                ...
                <div class="grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div class="text-left relative z-10">
                        ...
                        <p
                            ...
                            Telah menyelesaikan lebih dari ratusan proyek dan dipercaya oleh perusahaan milik negara
                            sebagai vendor penyedia layanan terbaik.
                        </p>
                    ...
                    <div class="hidden lg:flex justify-center relative">
                        <div
                            ...
                            <div
                                ...
                                <!-- <span
                  class="px-5 py-2 bg-white/90 backdrop-blur-md border border-slate-200 rounded-full text-xs font-bold uppercase tracking-widest text-slate-900">
                  View Gallery
                </span> -->
                            </div>
                    ...
                    <div
                        ...
                        <div class="max-w-2xl">
                            ...
                            <h3 class="text-5xl font-black text-slate-900 tracking-tighter leading-none">
                                Proyek Kita <br /> <span class="text-slate-400">Cakrawala Parama Internasional</span>
                            </h3>
                        </div>
                    </div>
                    ...
                    <div class="grid lg:grid-cols-2 gap-16 items-center">
                        ...
                        <div id="psikotest" class="order-2 lg:order-2">
                            ...
                            <h2 class="text-3xl md:text-5xl font-bold leading-tight text-slate-900">
                                Psikotes dan Asesmen <br class="hidden md:block" />
                                Layanan Pusat <span
                            ...
                            <p class="mt-6 text-lg text-slate-600 leading-relaxed">
                                Mengukur kompetensi dan kinerja untuk menilai kesesuaian dengan jabatan saat ini serta
                                mengidentifikasi potensi untuk mutasi atau promosi ke posisi lain.
                            </p>

                            <ul class="mt-8 space-y-4">
                                <li class="flex items-center gap-3 text-slate-700">
                                    <div class="w-1.5 h-1.5 rounded-full bg-brand"></div>
                                    <span>Analisis Kinerja Komprehensif</span>
                                </li>
                                <li class="flex items-center gap-3 text-slate-700">
                                    <div class="w-1.5 h-1.5 rounded-full bg-brand"></div>
                                    <span>Identifikasi Promosi yang Disesuaikan</span>
                                </li>
                            </ul>
                            ...
                            <div class="mt-10">
                                <button
                                    ...
                                    Pelajari Lebih Lanjut tentang Asesmen
                                    <span>→</span>
                                </button>
                            </div>
                        </div>
                ...
                <div class="max-w-7xl mx-auto px-4">
                    ...
                    <div class="text-center mb-20 relative z-10">
                        ...
                        <p class="text-slate-600 text-lg md:text-xl max-w-2xl mx-auto leading-relaxed">
                            Kami adalah profesional yang memberdayakan individu untuk mencapai lebih melalui ekosistem
                    ...
                    <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6 relative z-10">
                        ...
                        <div
                            ...
                            <p class="text-slate-600 text-sm leading-relaxed">
                                Menemukan talenta terbaik melalui solusi terpadu kami yang efektif <span
                        ...
                        <div
                            ...
                            <ul class="space-y-4 text-xs text-slate-600">
                                <li class="border-b border-slate-100 pb-2"><strong
                                        class="text-slate-900 block text-sm mb-1">Psychological Test</strong> Tes
                                    potensi online instan dengan hasil secara real-time.</li>
                                <li class="border-b border-slate-100 pb-2"><strong
                                        class="text-slate-900 block text-sm mb-1">Assessment
                                        Center</strong> Metode integratif untuk mengidentifikasi kepemimpinan dan
                                    kompetensi.
                                </li>
                                <li><strong class="text-slate-900 block text-sm mb-1">360° Assessment</strong>
                                    Umpan balik kinerja untuk pemetaan jalur karier yang jelas.</li>
                            </ul>
                        </div>
                        ...
                        <div
                            ...
                            <ul class="space-y-4 text-xs text-slate-600">
                                <li class="border-b border-slate-100 pb-2"><strong
                                        ...
                                        Training</strong> Metode pembelajaran yang inspiratif untuk transfer
                                    pengetahuan.</li>
                                <li class="border-b border-slate-100 pb-2"><strong
                                        class="text-slate-900 block text-sm mb-1">Coaching
                                        Clinic</strong> Rencana pengembangan diri melalui peningkatan kesadaran.</li>
                                <li><strong class="text-slate-900 block text-sm mb-1">Business Simulation</strong>
                                    Mengasah keterampilan melalui permainan berbasis kasus nyata.</li>
                            </ul>
                        </div>
                        ...
                        <div
                            ...
                            <ul class="space-y-4 text-xs text-slate-600">
                                <li class="border-b border-slate-100 pb-2"><strong
                                    ...
                                    Sistem untuk proses coaching dan peninjauan jalur karier.</li>
                                <li class="border-b border-slate-100 pb-2"><strong
                                        class="text-slate-900 block text-sm mb-1 italic">E-Service</strong>
                                    Mengembangkan budaya layanan untuk tim dan organisasi.</li>
                                <li><strong class="text-slate-900 block text-sm mb-1 italic">E-Survey</strong>
                                    Sistem integrasi untuk faktor pendorong keterlibatan karyawan.</li>
                            </ul>
                        </div>
                        ...
                        <div class="relative z-10">
                            ...
                            <div class="mt-8 space-y-6">
                                <p class="text-lg md:text-xl text-slate-600 leading-relaxed font-light">
                                    Lebih dari <span class="text-slate-900 font-bold">10 tahun pengalaman</span>
                                    Mengelola proyek desain interior di PT Cakrawala Parama Internasional.
                                </p>

                                <p class="text-slate-500 leading-relaxed">
                                    Kami telah menjadi salah satu pilihan terbaik untuk mewujudkan kebutuhan Anda dalam
                                    desain ruang, termasuk ruang pribadi, kafe, hotel, dan tempat usaha komersial.
                                </p>
                            </div>
                    ...
                    <div class="grid lg:grid-cols-2 gap-16 items-start">
                        ...
                        <div class="relative">
                            ...
                            <p class="mt-6 text-slate-600 text-lg leading-relaxed">
                                Mitra terpercaya Anda dalam menyelenggarakan berbagai acara, mulai dari pernikahan intim
                                hingga seminar internasional berskala besar.
                            </p>
                            ...
                            <div class="mt-12 space-y-12">
                                <div class="group">
                                    <h3 class="text-xl font-bold text-slate-900 flex items-center gap-3">
                                        ...
                                        Pernikahan Intim Spesial
                                    </h3>
                                    <p class="text-slate-500 text-sm mt-2 mb-4">Paket pernikahan yang fleksibel dan
                                        dapat disesuaikan, meliputi:</p>
                                    <div class="grid grid-cols-2 gap-3">
                                        <div v-for="item in ['Dekorasi Eksklusif', 'Pakaian Kustom', 'Pembawa Acara Profesional', 'Katering Premium']"
                                            :key="item"
                                ...
                                <div>
                                    ...
                                    <ul
                                        ...
                                        <li class="flex items-center gap-2 hover:text-brand transition-colors">•
                                            Konferensi Bisnis</li>
                                        <li class="flex items-center gap-2 hover:text-brand transition-colors">•
                                            Peluncuran Produk</li>
                                        <li class="flex items-center gap-2 hover:text-brand transition-colors">•
                                            Pertemuan Korporat</li>
                                        <li class="flex items-center gap-2 hover:text-brand transition-colors">•
                                            Acara Pemerintahan</li>
                                    </ul>
                                </div>
                                ...
                                <div
                                    ...
                                    <h4 class="text-brand font-black uppercase text-xs tracking-widest mb-3">Keahlian
                                        Terbukti</h4>
                                    <p class="text-slate-700 text-sm leading-relaxed italic relative z-10">
                                        "Salah satu pencapaian kami yang menonjol adalah berhasil menyelenggarakan
                                        seminar internasional selama pandemi COVID-19, bekerja sama dengan <span
                                            class="text-slate-900 font-bold underline decoration-brand">Dewan Perwakilan
                                            Rakyat</span> dan delegasi global."
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="grid lg:grid-cols-[1.4fr,1fr] gap-12 lg:gap-20 items-start">
                        ...
                        <div class="relative z-10 flex flex-col justify-center">
                            ...
                            <p class="text-lg text-slate-600 leading-relaxed font-light max-w-2xl mb-8">
                                Pembelajaran dan pelatihan kini menjadi lebih mudah dan efisien dengan Sistem Manajemen
                                Pembelajaran (LMS) terintegrasi kami. Solusi cerdas untuk pengembangan sumber daya
                                manusia yang adaptif dan fleksibel.
                            </p>
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-8">
                                ...
                                <div>
                                    ...
                                    <ul class="space-y-3">
                                        <li class="flex items-start gap-3 text-sm text-slate-600">
                                            <span class="text-brand">✔</span> Manajemen kursus, materi, & kelas virtual
                                        </li>
                                        <li class="flex items-start gap-3 text-sm text-slate-600">
                                            <span class="text-brand">✔</span> Forum diskusi, chat, & konferensi video
                                        </li>
                                        <li class="flex items-start gap-3 text-sm text-slate-600">
                                            <span class="text-brand">✔</span> Konten interaktif: video, kuis, & studi
                                            kasus
                                        </li>
                                        <li class="flex items-start gap-3 text-sm text-slate-600">
                                            <span class="text-brand">✔</span> Notifikasi & integrasi kalender akademik
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div>
                                    ...
                                    <ul class="space-y-3">
                                        <li class="flex items-start gap-3 text-sm text-slate-600">
                                            <span class="text-green-500 font-bold">↑</span> <b>Efisiensi Biaya:</b>
                                            Mengurangi biaya pelatihan
                                        </li>
                                        <li class="flex items-start gap-3 text-sm text-slate-600">
                                            <span class="text-green-500 font-bold">↑</span> <b>Kualitas Tenaga
                                                Kerja:</b>
                                            Kompetensi yang dioptimalkan
                                        </li>
                                        <li class="flex items-start gap-3 text-sm text-slate-600">
                                            <span class="text-green-500 font-bold">↑</span> <b>Kinerja Bisnis:</b>
                                            Organisasi yang jauh lebih unggul
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div class="mt-12 p-6 bg-brand/5 rounded-2xl border border-brand/10">
                                <p class="text-slate-900 font-semibold mb-1">Siap untuk bertransformasi?</p>
                                <p class="text-sm text-slate-600 mb-4">Hubungi kami sekarang untuk demo & konsultasi
                                    gratis!
                                </p>
                                <button
                ...
                <div class="py-24">
                    <div class="max-w-7xl mx-auto px-6">
                        <div class="text-center mb-16">
                            ...
                            <p class="text-3xl font-black text-slate-900 tracking-tighter">Berkolaborasi dengan
                                institusi terbaik.
                            </p>
                        </div>
                ...
                <div class="max-w-7xl mx-auto px-4 relative z-10">
                    <div class="grid lg:grid-cols-2 gap-16 mb-16">
                        ...
                        <div class="flex flex-col justify-between">
                            <div>
                                ...
                                <p class="mt-6 text-slate-500 max-w-sm">
                                    Siap meningkatkan potensi organisasi Anda? Mari mulai percakapan hari ini.
                                </p>
                            </div>
                        ...
                        <div class="space-y-10">
                            <div>
                                <h3 class="text-white font-bold mb-4 uppercase tracking-widest text-sm">Tetap Terhubung
                                </h3>
                                <p class="text-slate-400 leading-relaxed mb-6">
                                    Dapatkan pembaruan dan informasi kapan saja dari <span
                                        class="text-slate-200 font-semibold">PT Cakrawala
                                        Parama Internasional</span> dengan mengikuti media sosial kami!
                                </p>
